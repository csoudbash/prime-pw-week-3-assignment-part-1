...
let favoriteFoods = ['speghetti', 'steak', 'burgers'];
...
// 2.a. TODO: Log to the console the number of foods in your array
 console.log('Number of favorite food items:', favoriteFoods.length);
...
//     log both the food removed and the updated array
removedFood2 = favoriteFoods.shift();
